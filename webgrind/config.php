...
class Webgrind_Config extends Webgrind_MasterConfig {
    ...
    // static $pythonExecutable = 'C:/Python27/python.exe';
     #3
    static $pythonExecutable = 'C:\Users\Jeklin\AppData\Local\Programs\Python\Python35-32\python.exe';
    /**
     * Path to graphviz dot executable
     */
    static $dotExecutable = 'C:\Program Files (x86)\Graphviz2.38\bin\dot.exe';
